...
> _스프린트 미션 내 백엔드 요구사항은 [백엔드 레포지토리](https://github.com/codeit-sprint-fullstack/10-sprint-mission-be)의 브랜치에서 관리해주세요_
...
gtag는 처음 추가해보는데 생각보다 추가하는 방법이 너무 간단해서 놀랐다.<25.10.1>